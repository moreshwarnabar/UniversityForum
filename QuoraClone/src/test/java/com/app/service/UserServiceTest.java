...
public class UserServiceTest {
	...
	public void testAuthenticateUser() {
		...
		User u = new User("raj", "patil", parse("1998-10-10"), Gender.MALE, false, "rajpatil@university.com", "raj123",
				Role.STUDENT);
	...
	public void testFetchAllUsers() {
		...
		User u = new User("raj", "patil", parse("1998-10-10"), Gender.MALE, false, "rajpatil@university.com", "raj123",
				Role.STUDENT);
		User u1 = new User("rohit", "sharma", parse("1996-11-09"), Gender.FEMALE, false, "rohit@university.com",
				"rohit987", Role.FACULTY);
	...
	public void testFetchUserQuestions() {
		...
		Question q1 = new Question("which history book should refer for B.A history?", true,
				LocalDate.parse("2020-06-09"), category1);
